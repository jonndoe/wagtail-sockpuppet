...
if int(channels_version) >= 3:
    ...
    from sockpuppet.consumer_wagtail_two import SockpuppetConsumerAsgi as SockpuppetConsumer
    socket_patterns = [
        re_path(r'ws/sockpuppet-sync', SockpuppetConsumer.as_asgi())
    ]
else:
    #from sockpuppet.consumer import SockpuppetConsumer
    from sockpuppet.consumer_wagtail_two import SockpuppetConsumer
