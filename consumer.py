...
class BaseConsumer(JsonWebsocketConsumer):
    ...
    def render_page(self, reflex):
        ...
        print('+++++++++++++++++++ reflex_context is:', reflex_context)

        original_context_data = view.view_class.get_context_data
        print('+++++++++++++++++ original_context_data is : ', original_context_data)
        print('')

        print('++++++++++++++++++++++++ Starting first call to reflex.get_context_data(**reflex_context)')
        print('++++++++++++++++++++++++ Now reflex.context is empty:' ,reflex.context)
        print('')
        # in this initial call we update the empty reflex.context dict with (**relfex_context) data
        reflex.get_context_data(**reflex_context)
        print('++++++++++++++++++++++++++ Now reflex.context is: ', reflex.context)
